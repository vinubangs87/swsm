...
$signin = new userClass();
if(isset($_POST['submit']))
{ 
	$signin->user_login($_POST['reg_number'],$_POST['password']);
	$error = $signin->error;
}
?>
<!DOCTYPE html>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Please sign in to update your form</p>
      <p class="login-box-msg" style="color:red"><?php if(isset($error) && !empty($error)) { echo $error; } ?></p>
